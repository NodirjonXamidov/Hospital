            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 text-sm">
                        <div class="site-info">
                            <a href="#"><span class="mai-call text-primary"></span>+998 93 527 33 35</a>
                            <span class="divider">|</span>
                            <a href="#"><span class="mai-mail text-primary"></span> nodirbek05102001@gmail.com</a>
                        </div>
                    </div>
    ...
    <div align="center" style="padding: 70px;">
        <table border="1">
            <tr style="background-color: black">
                ...
                <th style="padding: 10px; font-size: 20px; color: white">Cencel Appointment</th>
            </tr>
